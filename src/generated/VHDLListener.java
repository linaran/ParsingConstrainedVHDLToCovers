...
public interface VHDLListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by {@link VHDLParser#in_out}.
   *
   * @param ctx the parse tree
   */
  void enterIn_out(VHDLParser.In_outContext ctx);

  /**
   * Exit a parse tree produced by {@link VHDLParser#in_out}.
   *
   * @param ctx the parse tree
   */
  void exitIn_out(VHDLParser.In_outContext ctx);
